...
base_url = ""
directorio_raiz = "./"
directorio_para_generar_el_archivo = "./search/"
output_file = "map.xml"
...
def generar_map(archivos):
    with open(directorio_para_generar_el_archivo + output_file, "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    print(f"map generado en {directorio_para_generar_el_archivo + output_file}")